...
const testimonials = [
  {
    quote: "Accord Protocol transformed how we settle peer-to-peer agreements. What used to feel risky now feels clear and secure.",
    author: "Sarah Chen",
    role: "CTO",
    company: "Meridian Labs",
    metric: "Secure P2P settlement",
  },
  {
