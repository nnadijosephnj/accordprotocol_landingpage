  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x2 = Number((100 + Math.cos(angle) * radius).toFixed(4));
        const y2 = Number((80 + Math.sin(angle) * radius).toFixed(4));
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            The Safest Way to Secure P2P Digital Transactions
            <br />
          </h2>
        </div>
