...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @accordprotocol/sdk

# or
yarn add @accordprotocol/sdk
pnpm add @accordprotocol/sdk`,
  },
  {
    label: "Initialize",
    code: `import { Accord } from '@accordprotocol/sdk'

const accord = new Accord({
  apiKey: process.env.ACCORD_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const escrow = await accord.escrow.create({
  asset: 'INJ',
  amount: '100',
